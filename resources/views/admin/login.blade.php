      ...
      <div class="container mt-5 align-item-center">
        <div class="row w-100">
          <div class="col-md-12 col-lg-6 col-xxl-10">
            ...
            <div class="row flex-row-reverse flex-column d-flex vh-100 justify-content-center align-items-center text-center mx-auto">
              <div class="col-12 d-block d-lg-none rounded-lg justify-content-center align-items-center text-center">
                <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                  <div class="carousel-inner rounded-lg">
                    <div class="carousel-item rounded-lg active">
                      <img src="{{asset('assets/img/carousel-login/gemoy.jpg')}}" class="d-block w-100 carousel-img-login" alt="...">
                    </div>
          ...
          <div class="col-6 col-xxl-2 d-none d-lg-block">
            <div id="carouselExampleSlidesOnly" class="carousel-login slide " data-ride="carousel">
              <div class="carousel-inner rounded-lg">
                <div class="carousel-item rounded-lg active">
                  <img src="{{asset('assets/img/carousel-login/gemoy.jpg')}}" class="d-block w-100 rounded" alt="...">
                </div>
                <div class="carousel-item">
                  <img src="{{asset('assets/img/carousel-login/gemoy2.jpg')}}" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                  <img src="{{asset('assets/img/carousel-login/gemoy3.jpg')}}" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                  <img src="{{asset('assets/img/carousel-login/gemoy4.jpg')}}" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                  <img src="{{asset('assets/img/carousel-login/gemoy5.jpg')}}" class="d-block w-100" alt="...">
                </div>
              </div>
            </div>
          </div>
