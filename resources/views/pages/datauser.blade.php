      ...
      <form action="{{ route('data-user.store') }}" method="POST">
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <input type="text" name="username" placeholder="Masukan Username" class="form-control" value="{{ old('username') }}" required>
            @error('user')
          ...
          <div class="form-group">
            ...
            <input type="password" class="form-control" name="password"  placeholder="Masukan Password Minimal 8 Karakter" value="{{ old('password') }}" required>
            @error('password')
            <small class="text-danger">{{ $message }}</small>
            @enderror
          </div>
      ...
      <form action="{{ route('data-user.update', $item->id) }}" method="POST">
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="username" id="username" placeholder="Masukkan Username" value="{{ $item->user }}" required>
            @error('username')
              <small class="text-danger">{{ $message }}</small>
            @enderror
          </div>
          ...
          <div class="form-group">
            ...
            <select name="level" class="form-control" required>
              ...
              <option value="penginput" {{ $item->level == 'penginput' ? 'selected' : '' }}>Penginput</option>
              <option value="viewer" {{ $item->level == 'viewer' ? 'selected' : '' }}>Viewer</option>
            </select>
            @error('level')
              <small class="text-danger">{{ $message }}</small>
            @enderror
